...
{
    public partial class HeatsPlannedVsActual24HourForm : Form
    {
        ...
        public HeatsPlannedVsActual24HourForm(DateTime selectedDate)
        {
        ...
        {
            cc1PlannedHeatsGroupBox.Text =
                cc2PlannedHeatsGroupBox.Text =
                cc3PlannedHeatsGroupBox.Text =
                    String.Format("Planned Heats as at {0}", SelectedDate.ToString("dd-MM 07:00"));

            List<HeatSummaryViewItem> plannedHeats =
                CasterReviewData.GetPlannedHeatsFor24Hours(SelectedDate);

            List<HeatSummaryViewItem> actualHeats =
                CasterReviewData.GetActualHeatsFor24Hours(SelectedDate);
            ...
            // Set the data sources for the 6x data components
            ...
            // Set the totals a the foot of each tab group box.
            cc1TabPlannedTotals.SetCasterHeatsTotals(
                cc1PlanHeats.Count, cc2PlanHeats.Count, cc3PlanHeats.Count);

            cc2TabPlannedTotals.SetCasterHeatsTotals(
                cc1PlanHeats.Count, cc2PlanHeats.Count, cc3PlanHeats.Count);

            cc3TabPlannedTotals.SetCasterHeatsTotals(
                cc1PlanHeats.Count, cc2PlanHeats.Count, cc3PlanHeats.Count);

            cc1TabActualTotals.SetCasterHeatsTotals(
                cc1ActHeats.Count, cc2ActHeats.Count, cc3ActHeats.Count);

            cc2TabActualTotals.SetCasterHeatsTotals(
                cc1ActHeats.Count, cc2ActHeats.Count, cc3ActHeats.Count);

            cc3TabActualTotals.SetCasterHeatsTotals(
                cc1ActHeats.Count, cc2ActHeats.Count, cc3ActHeats.Count);
        }
        ...
        private void HeatsPlannedVsActual24HourForm_Shown(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
    }
