...
namespace Elvis.UserControls.CasterMachineCondition
{
    ...
    public partial class UnitChangePrioritySingle : UserControl
    {
        ...
        /// </summary>
        public UnitChangePrioritySingle()
        {
            InitializeComponent();
            CustomiseColours();
        }
        ...
        public string GetData(int caster, int strand)
        {
            ...
            try
            {
                List<UnitChange> listUnitChange = ElvisDataModel.EntityHelper.CasterMachineCondition.
                                                  GetAllWithOrder<UnitChange>("it.Priority",
                                                  "it.caster=" + caster + " and it.strand=" + strand +
                                                  "and it.Priority = 4 ").ToList();
