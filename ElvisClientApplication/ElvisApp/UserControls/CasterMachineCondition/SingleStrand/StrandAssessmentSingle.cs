...
namespace Elvis.UserControls.CasterMachineCondition
{
    ...
    public partial class StrandAssessmentSingle : UserControl
    {
        ...
        /// <param name="e"></param>
        private void tableLayoutPanelSingleSummary_CellPaint(object sender, TableLayoutCellPaintEventArgs e)
        {
            Graphics g = e.Graphics;
            Rectangle r = e.CellBounds;

            //Get the cell value by row and column
            string cellValue = tableLayoutPanelSingleSummary.GetControlFromPosition(e.Column, e.Row).Text;
