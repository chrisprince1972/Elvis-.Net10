...
{
    class Layout1024x750 : Layout
    {
        public Layout1024x750(BackgroundWorker bgw)
        {
            playThread = bgw;
            ...
            VesselAngle = new Layout.Image(Video.X+Video.Width-80, Video.Y-8, 81, 81);
            ...
            Heat = new Layout.Text(6, 14, largeFont, white, left, center);
            Time = new Layout.Text(Width-39, 14, smallFont, white, right, center);
            ...
            Histo = new Layout.Image(Video.X+Video.Width-261, Video.Y+Video.Height-65, 256, 60);
            ...
            Additions = new Layout.Image(StreamLegend.X, StreamLegend.Y+20, StreamGraph.Width, (Video.Y+Video.Height)-(StreamLegend.Y+20));
